...
## Switches
set_property PACKAGE_PIN V17 [get_ports {da[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {da[0]}]
set_property PACKAGE_PIN V16 [get_ports {da[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {da[1]}]
set_property PACKAGE_PIN W16 [get_ports {da[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {da[2]}]
set_property PACKAGE_PIN W17 [get_ports {da[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {da[3]}]
set_property PACKAGE_PIN W15 [get_ports {db[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {db[0]}]
set_property PACKAGE_PIN V15 [get_ports {db[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {db[1]}]
set_property PACKAGE_PIN W14 [get_ports {db[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {db[2]}]
set_property PACKAGE_PIN W13 [get_ports {db[3]}]					
...
set_property PACKAGE_PIN W2 [get_ports {dd[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dd[0]}]
set_property PACKAGE_PIN U1 [get_ports {dd[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dd[1]}]
set_property PACKAGE_PIN T1 [get_ports {dd[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dd[2]}]
set_property PACKAGE_PIN R2 [get_ports {dd[3]}]					
...
#et_property PACKAGE_PIN W19 [get_ports btnL]						
